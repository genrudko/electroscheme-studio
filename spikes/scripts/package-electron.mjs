...
const result=await packager({dir:input,name:"ElectroSchemeSpikeElectron",electronVersion:"43.3.0",platform:process.platform,arch:"x64",out,overwrite:true,asar:{unpackDir:"tools"}});
